    ...
    <footer className="bg-gray-50 border-t border-gray-200 mt-16">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="space-y-4">
            <div className="flex items-center space-x-2">
              ...
              />
              <span className="font-bold text-lg text-slate-900">FacilityHub</span>
            </div>
            <p className="text-sm text-gray-600">Your premier destination for facility rentals and event management.</p>
          </div>
        ...
        <div className="border-t border-gray-200 mt-8 pt-8 flex flex-col sm:flex-row justify-between items-center">
          <p className="text-sm text-gray-600">© 2025 FacilityHub. All rights reserved.</p>

...
export function useExportTransactions() {
  return useMutation({
    mutationFn: (params?: Record<string, string>) => TransactionsAPI.exportTransactions(params),
    onSuccess: () => {
      toast({
        title: "Export Started",
        description: "Transaction export has been initiated",
      });
    },
    onError: (error: any) => {
      toast({
...
export function useExportUserTransactions() {
  return useMutation({
    mutationFn: (params?: Record<string, string>) => TransactionsAPI.exportUserTransactions(params),
    onSuccess: () => {
      toast({
        title: "Export Started",
        description: "User transaction export has been initiated",
      });
    },
    onError: (error: any) => {
      toast({
        title: "Export Failed",
        description: error.message || "Failed to export user transactions",
        variant: "destructive",
      });
    },
  });

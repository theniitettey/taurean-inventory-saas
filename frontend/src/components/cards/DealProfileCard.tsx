...
import { Card, Col, Dropdown, Form, ProgressBar, Row } from 'components/ui';
...
import { faCaretDown } from 'lucide-react';
...
const DealProfileCard = ({ className }: { className?: string }) => {
  ...
  return (
    <Card className={className}>
      <Card.Body>
        <Row className="items-center g-3">
          <Col sm="auto" className="flex-1">
            <h3 className="font-bolder mb-2 line-clamp-1">
            ...
            <div className="d-md-flex d-xl-block align-items-center justify-content-between mb-5">
              <div className="flex align-items-center mb-3 mb-md-0 mb-xl-3">

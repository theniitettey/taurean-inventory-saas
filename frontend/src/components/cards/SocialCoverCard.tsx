import { Card, Col, Dropdown, Row } from 'components/ui';
...
const SocialCoverCard = () => {
  return (
    <Card className="mb-8">
      <Card.Header
        className="flex justify-content-center align-items-end position-relative mb-7 mb-xxl-0"
      ...
      <Card.Body>
        <Row className="justify-content-xl-between">
          <Col xs="auto">
            <div className="flex flex-wrap mb-3 align-items-center">
              <h2 className="me-2">Erza Bridgest</h2>
              <span className="font-semibold fs-7 text-body-emphasis">
                u/hansolo
              </span>
            </div>
            <div className="mb-8">
                ...
                <div className="flex align-items-center">
                  ...
                  <Link to="#!" className="text-body-emphasis">
                    <span className="fs-7 fw-bold text-body-tertiary text-opacity-85 text-body-emphasis-hover">
                      1297
                      <span className="font-semibold ms-2 me-4">Followers</span>
                    </span>
                  </Link>
                </div>
                <div className="flex align-items-center">
                  ...
                  <Link to="#!" className="text-body-emphasis">
                    <span className="fs-7 fw-bold text-body-tertiary text-opacity-85 text-body-emphasis-hover">
                      3971
                      <span className="font-semibold ms-2 me-4">Following</span>
                    </span>
                  </Link>
                </div>
                <div className="flex align-items-center">
              ...
              <Col xs="auto">
                <div className="position-static">
                  <Dropdown align="end">
                    ...
                    >
                      < icon={ChevronDown} className="me-2" />
                      More
                    </Dropdown.Toggle>
